...
def main():
	kernel_v = np.array([[0, -1, 0], [0, 1, 0], [0, 0, 0]], dtype=np.float)
	kernel_h = np.array([[0, 0, 0], [-1, 1, 0], [0, 0, 0]], dtype=np.float)
	...
	cv2.imwrite("./result_14_v.jpg", gray_img_filtered_v)
	cv2.imwrite("./result_14_h.jpg", gray_img_filtered_h)
